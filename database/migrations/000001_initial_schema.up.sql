-- Initial database schema for FolioFox
-- Version: 1.0.0
-- Date: 2025-07-30
...
-- Note: FTS5 virtual table removed due to Alpine Linux SQLite compatibility
-- Full-text search will use standard SQLite LIKE queries for now
...
-- Note: PRAGMA statements removed as they cannot be used in transactions
-- These will be set by the application connection code instead